...
export default function PoiksVakan ({ auth, setAuth, myVakanId}) {
    ...
    useEffect(() => {
      ...
      axios.get('http://reiting.moscow:8002/api/vacancy/?&is_active=true', {
