...
import { Link } from 'react-router-dom'
 ...
 export default function SuccessFive () {
    return (
 ...
 />
    ...
    <section className={s.section__pay}>
        ...
        <div className={s.payF}>
            ...
            <p className={s.payF__title}>Оплата прошла успешно!</p>

            <Link to='/rezumeuser' className={s.payF__link}>Вернуться для показа номера</Link>
