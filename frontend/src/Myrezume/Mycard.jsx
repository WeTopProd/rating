...
export default function Mycard({onClick, CardId, employer, deletePost, applicants, ...info}) {
    ...
    async function favorites(id) {
        ...
        await axios
          ...
          .post(`http://localhost/api/resume/${info.id}/favorite/`, null, {
      ...
      async function favoritesDelete(id) {
        ...
        await axios
          ...
          .delete(`http://localhost/api/resume/${info.id}/favorite/`, {
    ...
    async function hideHandle (id) {
        ...
        await axios
          ...
          .post(`http://localhost/api/resume/${info.id}/deactivate/`, null, {
      ...
      async function hideHandleFalse(id) {
        ...
        .post(`http://localhost/api/resume/${info.id}/activate/`, null, {
