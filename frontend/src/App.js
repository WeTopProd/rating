...
function App() {
  ...
  useEffect(() => {
    ...
    axios.get('http://reiting.moscow:8002/api/resume/', {
...
useEffect(() => {
  ...
  axios.get('http://reiting.moscow:8002/api/vacancy/', {
...
const deletePost = (id) => {
  ...
  axios.delete(`http://reiting.moscow:8002/api/resume/${id}`,
...
const deletePostVakan = (id) => {
  ...
  axios.delete(`http://reiting.moscow:8002/api/vacancy/${id}`,
