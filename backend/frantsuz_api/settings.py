...
STATIC_URL = '/backend_static_rating/'
STATIC_ROOT = os.path.join(BASE_DIR, 'backend_static_rating/')

MEDIA_URL = '/backend_media_rating/'
MEDIA_ROOT = os.path.join(BASE_DIR, 'backend_media_rating/')
