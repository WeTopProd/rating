    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_salary', models.FloatField(verbose_name='Зарплата от')),
                ('final_salary', models.FloatField(verbose_name='Зарплата до')),
                ('start_experience', models.FloatField(verbose_name='Опыт от')),
                ('final_experience', models.FloatField(verbose_name='Опыт до')),
